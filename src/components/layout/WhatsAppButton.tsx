...
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      {/* Desktop tooltip */}
      <span className="pointer-events-none absolute right-16 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-full bg-charcoal px-3.5 py-1.5 text-[0.6875rem] font-semibold uppercase tracking-[0.14em] text-ivory opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100 lg:block hidden">
        Chat with us
      </span>
    </a>
  );
