...
export function FloatingMobileCta() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-charcoal/10 bg-ivory/95 backdrop-blur-xl shadow-[0_-10px_30px_rgba(22,15,11,0.10)] pb-[env(safe-area-inset-bottom)] lg:hidden">
