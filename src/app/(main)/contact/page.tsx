      ...
      <section className="mx-auto grid max-w-[1500px] gap-10 px-6 pb-16 md:px-12 md:pb-20 lg:grid-cols-[1.18fr_0.82fr] lg:px-16">
        ...
        <aside className="rounded-[2rem] bg-charcoal p-6 text-ivory shadow-[0_24px_80px_rgba(22,15,11,0.18)] md:p-8">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-[1.25rem] bg-[#0e7a4a]/20 p-4 sm:col-span-2">
              <p className="editorial-caption mb-2 text-[#0e7a4a]/80">WhatsApp</p>
              <a
                href={BUSINESS.whatsappUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-sm text-ivory transition-colors hover:text-[#0e7a4a]"
              >
